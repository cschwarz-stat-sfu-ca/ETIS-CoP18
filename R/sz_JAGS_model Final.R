...
#
#path.code <- 'C:/ETIS/analysis/R Code'   ## CJS set outside of code  path.Rcode
#path.data <- 'C:/ETIS/analysis/Processed Data'## CJS setoutside of code
#path.out.sum <- 'JAGS summaries'              ## CJS set outside of code
#path.out.mcmc <- 'C:/ETIS/2018 JAGS MCMCoutputs'## CJS set outside of code
