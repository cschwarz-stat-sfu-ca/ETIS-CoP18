...
#year.crit.from <- 2007  ## CJS change year.to to year.crit.to etc
#year.crit.to <- 2017

#file.cov <- 'covars_19072018.csv'
file.cov <- "covars_16012021.csv"    ## CJS updated file name
file.szs <- 'szs_ALL_17072018.csv'
file.szs <- 'szs_ALL_16012021.csv'   ## CJS updated file name

file.add.covars <- paste('Trade Route Ctry_Year un disc_TRUE_', 
                         year.crit.from, '_', year.crit.to, '.csv', sep = '')  ## CJS year.from to year.crit.from
